...
const shell = 'mx-auto w-full max-w-280 px-6'
    ...
    <>
      ...
      <header className="sticky top-0 z-20 border-b border-border bg-background/90 backdrop-blur-md">
        <div className={`${shell} flex items-center gap-7 py-4`}>
          <a href="/" className="mr-auto inline-flex items-center gap-2.5 font-display text-lg font-semibold text-text no-underline">
          ...
          <div className="flex items-center gap-3">
            <a href="/login" className={btnGhostSm}>
              Log in
            </a>
            <a href="/register" className={btnPrimarySm}>
              Start free
            </a>
          </div>
        </div>
          ...
          <div className={`${shell} grid grid-cols-1 md:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] gap-14 items-center`}>
            <div>
              ...
              <div className="flex flex-wrap gap-3.5">
                <a href="/register" className={btnPrimaryLg}>
                  Start studying free
                </a>
        ...
        <section className="pt-22 pb-24">
          <div className={shell}>
            <div className="grid justify-items-center gap-7 rounded-lg bg-accent-solid px-10 py-14 text-center text-on-accent">
              ...
              <a href="/register" className={btnPrimaryLgInverted}>
                Start studying free
              </a>
            </div>
          </div>
      ...
      <footer className="border-t border-border py-7">
        <div className={`${shell} flex flex-wrap items-center justify-between gap-4`}>
          <a href="/" className="inline-flex items-center gap-2.5 text-base text-text-muted no-underline">
            <img src={heroMark} alt="" className="rounded-md" width="22" height="22" />
            <span>Synapse</span>
          </a>
          <div className="flex gap-5 text-sm font-semibold">
            <a href="/login" className="text-text-muted no-underline hover:text-accent-solid">
              Log in
            </a>
            <a href="/register" className="text-text-muted no-underline hover:text-accent-solid">
              Create account
            </a>
          </div>
        </div>
