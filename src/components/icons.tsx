...
/**
 * Google's official "G". Its four brand colours are fixed, so unlike every other
 * icon here it does not take `currentColor`: Google's terms do not allow the mark
 * to be recoloured, and it stays legible on both themes as it is.
 */
export function IconGoogle({ className = 'h-5 w-5' }: IconProps) {
  return (
